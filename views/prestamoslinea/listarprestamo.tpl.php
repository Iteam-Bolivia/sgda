...
<script type="text/javascript">
    $("#flex1").flexigrid
    ({
        url: '<?php echo $PATH_DOMAIN ?>/prestamosLinea/gridprestamo/',
        dataType: 'json',
        colModel : [
        {display: 'Id', name : 'spr_id', width : 25, sortable : true, align: 'center'},            
        {display: 'Estado', name : 'spr_estado', width : 130, sortable : true, align: 'left'},        
  ...
  if (result=="Yes") {
            ...
            var url2="<?php echo $PATH_DOMAIN ?>/prestamosLinea/returnprestamo/";
          ...
          $(".pReload",".flexigrid").click();
            ...
            window.location.href="<?php echo $PATH_DOMAIN ?>/prestamosLinea/lisprestSelect/"+id+"/";
     ...
     var id=$('.trSelected div',grid).html();          
    window.location.href="<?php echo $PATH_DOMAIN ?>/prestamosLinea/verRpte_prestamo/"+id+"/";
     // window.location.href="<?php echo $PATH_DOMAIN ?>/prestamosLinea/verRpte_prestamo/";
          ...
          if($('.trSelected div',grid).html()){
               var id=$('.trSelected div',grid).html();
var url2="<?php echo $PATH_DOMAIN ?>/prestamosLinea/editEstSolPrestamo/";
          
              $("#recar4").load(url2,{valor:id});
              $(".pReload",".flexigrid").click();
          }
          else{
                $.msgbox("Seleccione un registro especifico");
