...
<form id="formA" name="formA" method="post" action="<?php echo $PATH_DOMAIN ?>/cotransferenciaFondo/<?php echo $PATH_EVENT ?>/<?php echo $VAR3 ?>/">
...
<script type="text/javascript">
    ...
    $(function() {	
        ...
        $("#cancelar").click(function(){
            location.href="<?php echo $PATH_DOMAIN ?>/cotransferenciaFondo/";
        });
    ...
    $(function() {
        $("#con_id").change(function(){
            ...
            $.ajax({
                url: '<?php echo $PATH_DOMAIN ?>/cotransferenciaFondo/obtenerSuc/',
                type: 'POST',
                data: 'Con_id='+con_id,
                dataType:  'text',
