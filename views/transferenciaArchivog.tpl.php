...
<div class="clear"></div>
<form id="formA" name="formA" method="post" class="validable" action="<?php echo $PATH_DOMAIN ?>/transferenciaArchivo/<?php echo $PATH_EVENT ?>/">
...
<script type="text/javascript">
    ...
    $("#flex1").flexigrid
    ({
        url: '<?php echo $PATH_DOMAIN ?>/transferenciaArchivo/loadExp/',
        dataType: 'json',
        colModel : [
            ...
            {display: 'Descripci&oacute;n', name : 'exp_descripcion', width : 95, sortable : true, align: 'left'},
    ...
    $("#flex2").flexigrid
    ({
        url: '<?php echo $PATH_DOMAIN ?>/transferenciaArchivo/loadFondo/',
        dataType: 'json',
        colModel : [
            {display: 'ID', name : 'exp_id', width : 40, sortable : true, align: 'center'},
            /*{display: 'Serie', name : 'ser_categoria', width : 70, sortable : true, align: 'left'},*/
            ...
            function test(com,grid)
            {
                if(com=="Transferir"){
                    if($('.trSelected',grid).length){
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo $PATH_DOMAIN ?>/transferenciaArchivo/find/",
                            data: "ids="+ids,
                            dataType: 'json',
                    ...
                    buttons: {
                        ...
                        Enviar: function() {
                            ...
                            if(sw){
                                $.ajax({
                                    type: "POST",
                                    url: "<?php echo $PATH_DOMAIN ?>/transferenciaArchivo/save/",
        ...
        <table width="619" border="0">
            ...
            <tr>
                ...
                <td width="190"><?php echo $fondo_des ?>
                    <input type="hidden" name="inst_fondo" id="inst_fondo" value="<?php echo $inst_fondo_id ?>">
