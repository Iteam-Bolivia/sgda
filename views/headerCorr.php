...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="<?php echo $PATH_WEB ?>/js/flexigridCorr.js"></script>
    ...
    <body>
        ...
        <div id="wrapper">
            <div id="header">
                <a href="#" class="logo">SISTEMA DE ARCHIVO DIGITAL</a>
                <a href="#" class="logot bold2">SISTEMA DE ARCHIVO DIGITAL</a> <span
                    class="user">Hola <?php echo $_SESSION['USU_NOMBRES']; ?> <?php echo $_SESSION['USU_APELLIDOS']; ?>|
                    <a href="<?php echo $PATH_DOMAIN; ?>/perfil/view/" title="Settings"><span
                            class="color2 boldU"><?php echo $_SESSION['ROL']; ?></span></a>| <a href="<?php echo $PATH_DOMAIN; ?>/perfil/view/" title="Settings"><span
                            class="color2 boldU">Configuraci&oacute;n</span></a> | <a href="<?php echo $PATH_DOMAIN; ?>/login/logout/" title="Settings"><span
                            class="color2 boldU">Salir</span></a>

                    <div>&Uacute;ltima sesi&oacute;n: <?php echo utf8_encode(strftime("%A %d de %B del %Y")); ?></div>
                </span>
            </div>
            <div id="container">
                <div id="containerTop">
