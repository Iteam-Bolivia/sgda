...
var sessioncant="";
    $("#flex1").flexigrid
    ({
        url: '<?php echo $PATH_DOMAIN ?>/prestamos/search/',
        dataType: 'json',
        colModel : [
...
$("#archivos").val($('.trSelected div',grid).html());
        if (com=='Imprimir'){            
            $("#formA").attr("action","<?php echo $PATH_DOMAIN ?>/prestamos/rpteBuscar/");
            document.getElementById('formA').submit();                        
        }
if (com=='Adicionar'){  
        ...
        if (com=='Exportar'){
            if($('.fil_chk',grid).length > 0){
                ...
                //if($("#sw").val()=='1'){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo $PATH_DOMAIN ?>/prestamos/<?php echo $PATH_EVENT_EXPORT ?>/",
...
<script type="text/javascript">
    ...
    $("#fon_id").change(function(){
        if($("#fon_id").val()==""){
            ...
            $.ajax({
                url: '<?php echo $PATH_DOMAIN ?>/prestamos/loadAjaxUnidades/',
                type: 'POST',
    ...
    $("#uni_id").change(function(){  
        if($("#uni_id").val()==""){
            ...
            $.ajax({
                url: '<?php echo $PATH_DOMAIN ?>/prestamos/loadAjaxSeries/',
                type: 'POST',
    ...
    $("#ser_id").change(function(){  
        if($("#ser_id").val()==""){
            ...
            $.ajax({
                url: '<?php echo $PATH_DOMAIN ?>/prestamos/loadAjaxTramites/',
                type: 'POST',
   ...
   $("#tra_id").change(function(){  
        if($("#tra_id").val()==""){
            ...
            $.ajax({
                url: '<?php echo $PATH_DOMAIN ?>/prestamos/loadAjaxCuerpos/',
                type: 'POST',
