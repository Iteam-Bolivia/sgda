...
class prestamoslinea extends tab_archivo {
...
//        }
       ...
       $where .= " AND $valor ";            
        ...
        function buscarprestlinea($busquedaArray) {
         $valor="";$id_listar="";
  if(isset($_SESSION['id_lista2'])){
    $id_listar=$_SESSION['id_lista2'];
    //$id_listar=$_SESSION['id_lista'];
...
//        }
       ...
       $where .= " AND $valor ";            
        ...
        echo $json;
            ...
            function buscarpresList($busquedaArray) {
         $valor="";$id_listar="";
  if(isset($_SESSION['id_lista2'])){
    $id_listar=$_SESSION['id_lista2'];
    //$id_listar=$_SESSION['id_lista'];
...
//        }
      ...
      function buscar2preslinea($busquedaArray) {
  $valor="";$id_listar="";
  if(isset($_SESSION['id_lista2'])){
    $id_listar=$_SESSION['id_lista2'];
  }
...
//        }
       ...
       $where .= " AND $valor ";            
        ...
        echo $json;
         ...
         function buscar2preslinealistar($busquedaArray,$id) {
...
WHERE
tab_solprestamo.spr_id=$id_listar";
         $docprestamo=new tab_docprestamo();
         $resultlistprestamo=$docprestamo->dbSelectBySQL($sqlista);
         $cantidad=count($resultlistprestamo);
                    $i=0;
         foreach($resultlistprestamo as $listprest){
            
        $valor.=" tab_archivo.fil_id=".$listprest->fil_id;  
        	if($i<$cantidad-1){
		$valor.=" or ";
		}
                                        $i++;
