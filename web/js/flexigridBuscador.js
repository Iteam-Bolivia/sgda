...
//                p.fon_id = $('#fon_id').val();                
                p.uni_id = $('#uni_id').val();
                p.ser_id = $('#ser_id').val();
                p.tra_id = $('select[name=tra_id]').val();
                p.cue_id = $('select[name=cue_id]').val();
                p.exp_titulo = $('#exp_titulo').val();
                p.fil_nur = $('#fil_nur').val();
                p.fil_titulo = $('#fil_titulo').val();
                p.pac_nombre = $('#pac_nombre').val();
                p.fil_subtitulo = $('#fil_subtitulo').val();
...
//                    }                    
            ...
            (
                function ()
                {
                    ...
                    .click(
                        function (e)
                        {
                            if(typeof (p.mulSelec)=="undefined"){
                                ...
                                if($('tbody tr.trSelected',g.bDiv).length>1){
                                    $(this).siblings().removeClass('trSelected');
                                    return false;
                                }
                            }else{
            ...
            if (!btn.separator)
            {
                ...
                if (btn.onpress)
                {
                    ...
                    (
                        function ()
                        {
                            $(".tDiv2 div",g.gDiv).removeClass('fbuttonH');
                            $("div",this).addClass('fbuttonH');
    ...
    if (p.usepager)
    {
        ...
        if (p.searchitems)
        {
            ...
            $(g.sDiv).append("<div class='sDiv2'>Buscar: <input type='text' size='30' name='q' class='qsbox' /> <select name='qtype' class='qtype'>"+sopt+"</select> <input type='button' class='Search' value='Buscar' /> <input type='hidden' value='Limpiar' /></div>");
    ...
    if ($('th',g.hDiv).length)
    {
        ...
        .html('<div></div>')
        .attr('title','Ocultar/Mostrar Columnas')
        .click
        (
            function ()
            {
